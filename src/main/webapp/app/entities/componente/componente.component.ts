...
export class ComponenteComponent implements OnInit, OnDestroy {
  ...
  loadAll() {
    this.componenteService
      ...
      .subscribe((res: HttpResponse<IComponente[]>) => this.paginateComponentes(res.body, res.headers));
  }
  ...
  protected paginateComponentes(data: IComponente[], headers: HttpHeaders) {
