...
export class CalificacionComponent implements OnInit, OnDestroy {
  ...
  loadAll() {
    this.calificacionService
      ...
      .subscribe((res: HttpResponse<ICalificacion[]>) => this.paginateCalificacions(res.body, res.headers));
  }
  ...
  protected paginateCalificacions(data: ICalificacion[], headers: HttpHeaders) {
