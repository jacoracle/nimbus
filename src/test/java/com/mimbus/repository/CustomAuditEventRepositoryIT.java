...
import com.mimbus.config.audit.AuditEventConverter;
import com.mimbus.domain.PersistentAuditEvent;
...
import static com.mimbus.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
